    ...
    return (
        <div className="max-w-6xl mx-auto p-6 space-y-6 bg-gradient-to-r from-pink-100 via-white to-purple-100 min-h-screen rounded-lg shadow-lg">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
                {activeTab === "Spotlight on Trending Looks" && <TrendingLooksSection />}
...
const TrendingLooksSection = () => {
    return (
        <div className="space-y-6">
            <h2 className="text-2xl font-bold text-pink-600">Spotlight on Trending Looks</h2>
            <p className="text-gray-700">
...
const PersonalStylistSection = () => {
    ...
    const handleGenerateOutfit = () => {
        const outfitIdeas = {
            ...
            formal: ["Elegant gown with heels", "Tailored suit with statement jewelry"],
    ...
    return (
        <div className="space-y-6">
            <h2 className="text-2xl font-bold text-pink-600">Your Personal Stylist</h2>
            <p className="text-gray-700">
            ...
            <div className="flex items-center space-x-4 mt-4">
                <input
                    ...
                    value={event}
                    onChange={(e) =>
                        setEvent(e.target.value.toLowerCase() as "casual" | "formal" | "party")
                    }
...
const FashionStorySection = () => {
    return (
        <div className="space-y-6">
            <h2 className="text-2xl font-bold text-pink-600">Fashion Story of the Week</h2>
            <p className="text-gray-700">
