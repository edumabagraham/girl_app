    ...
    return (
        <div className="max-w-4xl mx-auto p-6 space-y-6 bg-gradient-to-r from-pink-100 to-purple-100 rounded-lg shadow-lg">
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
                <h2 className="text-2xl font-bold text-pink-600">Daily 5-Minute Video</h2>
                <div className="mt-4">
                    <ReactPlayer
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
                <h2 className="text-2xl font-bold text-pink-600">How Are You Feeling Today?</h2>
                <div className="flex justify-around mt-6">
                    {["😊", "😐", "😢", "😡", "😴", "🤩"].map((emoji) => (
                        <button
                            key={emoji}
                            onClick={() => setMood(emoji)}
                            className={`text-4xl hover:scale-110 transition-transform ${mood === emoji ? "ring-4 ring-pink-500" : ""
                                }`}
                        >
                            {emoji}
                        </button>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
                <h2 className="text-2xl font-bold text-pink-600">Mental Health Resources</h2>
                <ul className="mt-6 space-y-4">
                    {mentalHealthResources.map((resource, index) => (
                        <li key={index} className="bg-pink-50 p-4 rounded-lg shadow-md">
                            <h3 className="text-lg font-semibold text-pink-600">{resource.title}</h3>
